...
exports.companyRouter = (0, trpc_1.createTRPCRouter)({
    // Get all companies
    getAll: trpc_1.protectedProcedure.query(async () => {
        return [];
    }),
    // Get current company (for CS practice)
    getCurrent: trpc_1.protectedProcedure.query(async ({ ctx }) => {
    ...
    updateSettings: trpc_1.protectedProcedure
        .input(zod_1.z.object({
        invoicePrefix: zod_1.z.string().optional(),
        paymentTerms: zod_1.z.string().optional(),
        lateFeePenalty: zod_1.z.number().optional(),
    ...
    getSettings: trpc_1.protectedProcedure.query(async () => {
        const company = getCurrentCompanyData();
        return company.settings;
    }),
    // Update company branding
    updateBranding: trpc_1.protectedProcedure
        .input(zod_1.z.object({
    ...
    getBranding: trpc_1.protectedProcedure.query(async () => {
        const company = getCurrentCompanyData();
