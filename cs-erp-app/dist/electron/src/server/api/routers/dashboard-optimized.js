...
exports.dashboardOptimizedRouter = void 0;
const zod_1 = require("zod");
const trpc_1 = require("../trpc");
const server_1 = require("@trpc/server");
exports.dashboardOptimizedRouter = (0, trpc_1.createTRPCRouter)({
    /**
    ...
    getMetrics: trpc_1.protectedProcedure
        ...
        const [invoiceMetrics, quarterlyInvoiceMetrics, overdueInvoices, outstandingInvoices, customerCount, paymentMetrics, complianceMetrics] = await Promise.all([
     ...
     */
    getRecentActivity: trpc_1.protectedProcedure
        .query(async ({ ctx }) => {
        if (!ctx.companyId) {
            throw new server_1.TRPCError({
                code: 'UNAUTHORIZED',
