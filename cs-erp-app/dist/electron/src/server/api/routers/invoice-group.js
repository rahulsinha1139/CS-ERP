...
exports.invoiceGroupRouter = void 0;
const zod_1 = require("zod");
const trpc_1 = require("../trpc");
const server_1 = require("@trpc/server");
const id_generator_1 = require("@/lib/id-generator");
exports.invoiceGroupRouter = (0, trpc_1.createTRPCRouter)({
    /**
    ...
    create: trpc_1.protectedProcedure
        ...
        groupType: zod_1.z.string().default('QUARTERLY'),
        periodStart: zod_1.z.date().optional(),
        periodEnd: zod_1.z.date().optional(),
    }))
        .mutation(async ({ ctx, input }) => {
        const group = await ctx.db.invoiceGroup.create({
            data: {
                id: id_generator_1.idGenerator.invoiceGroup(),
     ...
     */
    addInvoice: trpc_1.protectedProcedure
        .input(zod_1.z.object({
     ...
     */
    removeInvoice: trpc_1.protectedProcedure
        .input(zod_1.z.object({
        groupId: zod_1.z.string().min(1),
        invoiceId: zod_1.z.string().min(1),
    }))
