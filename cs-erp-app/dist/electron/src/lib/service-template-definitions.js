...
exports.SERVICE_CATEGORIES = exports.CS_SERVICE_TEMPLATES = void 0;
...
const custom_fields_1 = require("@/types/custom-fields");
exports.CS_SERVICE_TEMPLATES = [
    // ===== COMPANY INCORPORATION =====
    {
        ...
        customFields: [
            ...
            },
            {
                ...
                validation: {
                    pattern: custom_fields_1.FIELD_PATTERNS.CIN.source,
                    message: custom_fields_1.VALIDATION_MESSAGES.INVALID_CIN,
                },
                group: 'Company Details',
            },
            {
    ...
    // ===== DIRECTOR APPOINTMENT =====
    {
        ...
        customFields: [
            ...
            },
            {
                ...
                validation: {
                    pattern: custom_fields_1.FIELD_PATTERNS.DIN.source,
                    message: custom_fields_1.VALIDATION_MESSAGES.INVALID_DIN,
                },
                group: 'Director Information',
            },
            {
                ...
                validation: {
                    pattern: custom_fields_1.FIELD_PATTERNS.PAN.source,
                    message: custom_fields_1.VALIDATION_MESSAGES.INVALID_PAN,
                },
                group: 'Director Information',
            },
            {
...
function getTemplateByName(name) {
    return exports.CS_SERVICE_TEMPLATES.find((t) => t.name === name);
}
// Utility: Get all template names
function getAllTemplateNames() {
    return exports.CS_SERVICE_TEMPLATES.map((t) => t.name);
}
// Utility: Get templates by category
function getTemplatesByCategory(category) {
    return exports.CS_SERVICE_TEMPLATES.filter((t) => t.category === category);
}
